...
%arduino=serialport("COM13",1000000);           %只需要运行1次，连接端口
...
%通过鱼眼摄像头计算方块的位置
Loc=CVsystem5T;%TutorialBasic1为使用平均值算法，TutorialBasic2为寻找最小值算法,TutorialBasic2Bnew使用新的激光识别算法
pot=Loc;%pot=PositionTranR2(Loc(1),Loc(2));
t = 0:0.1:6;
X1 = pot(1,1)/100;  % Z
Y1 = pot(1,2)/100; % -X
Z1 = -0.01;  % Y - GREEN
...
qi1(1,4)=qi1(1,2)+qi1(1,3)+Loc(3);%+Loc(3)*pi/180;%添加抓取点末端位姿，加入了姿态调整
