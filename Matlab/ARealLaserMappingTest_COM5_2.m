%% 真实环境下激光检测测试（真实小车） Real fisheye camera laser extraction and mapping test
...
%cam=webcam(2);black_image =snapshot(cam);hsvImage = rgb2hsv(black_image);imshow(hsvImage);
%preview(cam);
...
CALIBRATION_FILE = 'Omni_Calib_Results_Real_Car.mat';%真实小车的摄像头
